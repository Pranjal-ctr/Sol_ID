/**
 * CreateProfile — on-chain profile creation form.
 *
 * Features a .sol-style username input where the user types just the handle
 * and the ".sol" suffix is shown as a fixed visual decoration.
 * Calls createProfile() on the Anchor program once submitted.
 */
          ...
          <div className="cp-field">
            ...
            <div className="cp-hint-row">
              {validationError ? (
                ...
                <span className="cp-hint cp-hint--ok">
                  ✓ {raw}.sol — looks good
                </span>
              ) : (
                <span className="cp-hint">
                  Lowercase letters, numbers, hyphens · max {MAX_LEN} chars
                </span>
              )}
